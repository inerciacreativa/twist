...
final class ArrTest extends TestCase
{
	...
	public function testExcept(): void
	{
		...
		$array = ['name' => 'Jose', 'framework' => ['language' => 'PHP', 'name' => 'Twist']];
		$this->assertEquals(['name' => 'Jose'], Arr::except($array, 'framework'));
		$this->assertEquals(['name' => 'Jose', 'framework' => ['name' => 'Twist']], Arr::except($array, 'framework.language'));
	...
	{
		$array = ['one', 'two', 'three'];
		$this->assertEquals(['one', 'two', 'three', 'four'], Arr::push($array, 'four'));
		$this->assertEquals(['one', 'two', 'three', 'four', 'six', 'seven', 'eight'], Arr::push($array, 'six', 'seven', 'eight'));
	}
	...
	public function testDefaults(): void
	{
		...
		$this->assertEquals(['role' => 'developer', 'isActive' => false], Arr::defaults($defaults, ['name' => false, 'isActive' => false]));
		$this->assertEquals(['role' => 'developer', 'isActive' => false, 'name' => 'Jose'], Arr::defaults($defaults, ['isActive' => false, 'name' => 'Jose'], ['name']));
	...
	{
		$array = ['Name' => 'Jose', 'Mail' => 'jose@example.com', 'isActive' => false, 'test' => null];

		$this->assertEquals(['Mail' => 'jose@example.com', 'isActive' => false, 'test' => null], Arr::remove($array, 'name'));
		$this->assertEquals(['Name' => 'Jose', 'Mail' => 'jose@example.com'], Arr::remove($array, ['isactive', 'test']));

		// Strict
		$this->assertEquals(['Name' => 'Jose', 'Mail' => 'jose@example.com', 'test' => null], Arr::remove($array, 'isActive', false));
		$this->assertEquals(['isActive' => false, 'test' => null], Arr::remove($array, ['Name', 'Mail']));

		// Remove null values
		$this->assertEquals(['Name' => 'Jose', 'Mail' => 'jose@example.com', 'isActive' => false], Arr::remove($array));
	}
